...
INSERT INTO `guost` (`IDNTITY`, `email`, `distract`, `datres`, `password`, `Rid_num`) VALUES
('2431', 'z.alhashmi7@gmail.com ', 'dalea ', '2022-02-13 21:56:17', NULL, 1);
...
--
ALTER TABLE `guost`
  ADD PRIMARY KEY (`Rid_num`),
  ADD UNIQUE KEY `IDNTITY` (`IDNTITY`),
